...
controller.hears(["[ultimo|último|ult~] encontro","^pattern$"],["direct_message","direct_mention","mention","ambient"],function(bot,message) {
...
controller.hears(["[proximo|próximo|prox~] encontro"],["direct_message","direct_mention","mention","ambient"],function(bot,message) {
  bot.reply(message,'O próximo encontro será no dia 04/06 às 14:00 - estamos até barganhando um coffe break...');
});

controller.hears(["Evento"],["direct_message","direct_mention","mention","ambient"],function(bot,message) {
